 ...
 *
 * andorid 4+
 * var a= bens.require("editpicture");
 *  new a({
...
(function(){
    ...
    var editPicture=function(data){
        ...
        this.success=bens.getFunction(data.success);
        this.cancel=bens.getFunction(data.cancel);

        this.imgOutWidth=data.width || 80;
        this.imgOutHeight=data.height || 80;

        this.div = bens.getDom(this.id);
...
//        this.div2 = null;
    ...
    editPicture.prototype={
        ...
        //设置包裹层css
        setDivCss:function(){
            var temp = this.div.style;
            if(temp.position == "relative" || temp.position == "absolute"){
...
//            this.div2 = div4;
        ...
        createButton:function(){
            var div1 = document.createElement("div"),
                ...
                allcss = "z-index:500;width:34pt;height:24pt;"+device.background_size+":34pt 24pt;position:absolute;";
        ...
        editButtonEventBind:function(){
            ...
            $$(this.yes)
                .myclickdown(function(){
                    $(this).css({background:"url('"+_yes+"')"});
                })
                .myclickup(function(){
                    $(this).css({background:"url('"+yes+"')"});
                })
                .myclickok(function(){
                    _this.saveAsImg();
                });
            ...
            $$(this.no)
                .myclickdown(function(){
                    $(this).css({background:"url('"+_cancel+"')"});
                })
                .myclickup(function(){
                    $(this).css({background:"url('"+cancel+"')"});
                })
                .myclickok(function(){
                    _this.cancel();
                });
            ...
            $$(this.roteleft)
                .myclickdown(function(){
                    $(this).css({background:"url('"+_roteright+"')"});
                })
                .myclickup(function(){
                    $(this).css({background:"url('"+roteleft+"')"});
                })
                .myclickok(function(){
            ...
            $$(this.roteright)
                .myclickdown(function(){
                    $(this).css({background:"url('"+_roteleft+"')"});
                })
                .myclickup(function(){
                    $(this).css({background:"url('"+roteright+"')"});
                })
                .myclickok(function(){
